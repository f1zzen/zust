...
<div align="center">
  ...
  <p align="center">
    Очень простой интерфейс для работы с обходами блокировок.
    <br />
...
Пытаясь помочь людям с настройкой обхода блокировок я столкнулся с множеством проблем "непонимая": начиная как с установкой, так и проблемами. Люди не могли понять куда что нажимать, откуда скачивать.. И даже при детальнейшей инструкции у людей появлялось невероятно куча вопросов и разных проблем. В качестве решения мне захотелось объединить популярные методы обхода блокировок в одно приложение - ZuST (пока что, только zapret). Так же программа исправляет проблему десятки разных папок с запретом, и объединяет готовые решения в одну программу.
